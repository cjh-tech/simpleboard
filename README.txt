...
코로나 openapi(xml) 영화openapi(json) 를 이용 데이터를 가져와 차트를 보여주는 사이트를 만들었습니다
...
제작기간: 4주
프로젝트 기여도: 서버패포 포함 100% 

프로젝트는 현재 정상적으로 동작하고 있습니다 
// chart.js 영화진흥위원회의 데이터중 제목부분의 글자가 많아 화면의 배열이 고르지 못한경우가 있습니다
// 서버주소 : http://3.137.167.39:8080/home/api
