...
<body>
     <div class="container">
      ...
      <div class="jumbotron">
        ...
        <h3>공공데이터포털의 코로나 openapi(XML) 이용</h3>
        <h3>영화진흥위원회의 openapi(JSON) 이용 </h3>
        <hr></hr>
        <h4> HTML CSS JQUERY AJAX SPRING ORACLE 등 여러가지 언어를 사용</h4>
        <h4> 서버배포 포함 프로젝트 기여도 100%</h4>
        <hr></hr>
        <h4> 배운내용을 깃허브에 올려가며 개발자의 역량을 쌓고 있습니다 </h4>
        <a class="btn btn-lg btn-success" href="https://github.com/cjh-tech/simpleboard" role="button">GitHub로 이동</a>
